...
public class VuforiaVisionTileRunner {
        ...
        private static final float mmTargetHeight = 6.0f * TileRunnerInfo.mmPerInch;

        // Constant for Stone Target.
        private static final float stoneZ = 2.0f * TileRunnerInfo.mmPerInch;

        // Constants for the center support targets.
        private static final float bridgeZ = 6.42f * TileRunnerInfo.mmPerInch;
        private static final float bridgeY = 23.0f * TileRunnerInfo.mmPerInch;
        private static final float bridgeX = 5.18f * TileRunnerInfo.mmPerInch;
        private static final float bridgeRotY = 59.0f;  // Units are degrees
        private static final float bridgeRotZ = 180.0f;

        // Constants for perimeter targets
        private static final float halfField = 72.0f * TileRunnerInfo.mmPerInch;
        private static final float quadField = 36.0f * TileRunnerInfo.mmPerInch;

        public VuforiaVisionTileRunner(CknVuforia vuforia, OpenGLMatrix phoneLocation){
            ...
            vuforia.addTargetList(TileRunnerInfo.TRACKABLES_FILE_NAME, imageTargetsInfo, phoneLocation);
