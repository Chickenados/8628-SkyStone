...
public void extend(CknEvent event, double timeout){
        ...
        this.grabberPID.setSetPoint(TileRunnerInfo.GRABBER_EXTENDED_ENCODER_COUNT, false);
        this.event = event;
        setTaskEnabled(true);
        }
...
public void retract(CknEvent event, double timeout){
        this.startTime = CknUtil.getCurrentTime();
        this.timeout = timeout;
        this.grabberPID.setSetPoint(TileRunnerInfo.GRABBER_RETRACTED_ENCODER_COUNT, false);
        this.event = event;
        setTaskEnabled(true);
        }
...
public void lowPosition(CknEvent event, double timeout){
        this.startTime = CknUtil.getCurrentTime();
        this.timeout = timeout;
        this.grabberPID.setSetPoint(TileRunnerInfo.GRABBER_LOW_POSITION_ENCODER_COUNT, false);
        this.event = event;
        setTaskEnabled(true);
        }
...
public void highPosition(CknEvent event, double timeout){
        this.startTime = CknUtil.getCurrentTime();
        this.timeout = timeout;
        this.grabberPID.setSetPoint(TileRunnerInfo.GRABBER_HIGH_POSITION_ENCODER_COUNT, false);
        this.event = event;
        setTaskEnabled(true);
        }
