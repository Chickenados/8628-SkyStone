...
public class VuforiaVision {
    ...
    private static final float stoneZ = 2.0f * mmPerInch;
    ...
    public VuforiaVision(CknVuforia vuforia, OpenGLMatrix phoneLocation){
        ...
        vuforia.addTargetList(SkybotInfo.TRACKABLES_FILE_NAME, imageTargetsInfo, phoneLocation);
